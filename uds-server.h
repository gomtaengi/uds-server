...
/* SA NRCs */
#define SA_NRC_SUB_FUNCTION_NOT_SUPPORTED                   0x12
#define SA_NRC_INCORRECT_MESSAGE_LENGTH_OR_INVALID_FORMAT   0x13
#define SA_NRC_CONDITIONS_NOT_CORRECT     0x22
#define SA_NRC_REQUEST_SEQUENCE_ERROR     0x24
#define SA_NRC_REQUEST_OUT_OF_RANGE       0x31
#define SA_NRC_INVALID_KEY                0x35
#define SA_NRC_EXCEED_NUMBER_OF_ATTEMPTS  0x36
#define SA_NRC_REQUIRED_TIME_DELAY_NOT_EXPIRED              0x37
